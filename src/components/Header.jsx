...
const Header = () => {
  ...
  return (
    <nav className="w-full bg-blue-500 shadow fixed">
      <div className="justify-between px-4 mx-auto lg:max-w-7xl md:items-center md:flex md:px-8">
        <div>
          <div className="flex items-center justify-between py-3 md:py-2 md:block">
            <Link to="/">
              <h2 className="text-2xl font-bold text-white">Inventory Telti</h2>
            </Link>
        ...
        <div>
          ...
          >
            <ul className="items-center justify-center space-y-8 md:flex md:space-x-6 md:space-y-0 md:pt-9 pt-0 text-center">
              <li>
                <Link
                  to="/"
                  className="text-white hover:text-indigo-200 text-2xl md:text-3xl"
                >
                  Home
                </Link>
              </li>
